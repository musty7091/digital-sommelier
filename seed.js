...
// Tek seferlik çalıştırılır: 30 örnek ürün + kioskSettings yazar.
//
...
const products = [
  ...
  { barcode: '8690000000257', name: 'Chablis Grand Cru', brand: 'Domaine Chablis', color: 'white', country: 'FR', region: 'Burgundy', grape: 'Chardonnay', price: 2100, stock: 11, block: 'B', shelf: 12, active: true, body: 'medium', sweetness: 'light', acidity: 'intense', tannin: 'light', usagePurposes: ['food', 'premium', 'celebration'], sommelierPick: true, priorityScore: 21, featured: false, image: '', shortDescription: tn('Mineralli ve prestijli beyaz.', 'Mineral and prestigious white.'), tasteNotes: tn('Yeşil elma, deniz kabuğu.', 'Green apple, seashell.'), foodPairing: tn('İstiridye, kabuklu deniz ürünleri.', 'Oysters, shellfish.') },
  { barcode: '8690000000264', name: 'Rioja Reserva', brand: 'Bodega Clasica', color: 'red', country: 'ES', region: 'Rioja', grape: 'Tempranillo', price: 1450, stock: 17, block: 'A', shelf: 16, active: true, body: 'medium', sweetness: 'light', acidity: 'medium', tannin: 'medium', usagePurposes: ['food', 'gift', 'premium'], sommelierPick: false, priorityScore: 16, featured: true, image: '', shortDescription: tn('Fıçı dinlendirmeli olgun kırmızı.', 'Oak-aged mature red.'), tasteNotes: tn('Kurutulmuş meyve, tütün, deri.', 'Dried fruit, tobacco, leather.'), foodPairing: tn('Izgara etler, olgun peynirler.', 'Grilled meats, aged cheeses.') },
  { barcode: '8690000000271', name: 'Coonawarra Cabernet', brand: 'Aussie Estate', color: 'red', country: 'AU', region: 'Coonawarra', grape: 'Cabernet Sauvignon', price: 1250, stock: 22, block: 'A', shelf: 17, active: true, body: 'intense', sweetness: 'light', acidity: 'medium', tannin: 'intense', usagePurposes: ['food', 'daily', 'premium'], sommelierPick: true, priorityScore: 18, featured: false, image: '', shortDescription: tn('Nane ve okaliptüs dokunuşlu.', 'Mint and eucalyptus hints.'), tasteNotes: tn('Siyah frenk üzümü, nane.', 'Blackcurrant, mint.'), foodPairing: tn('Kuzu tandır, kırmızı et.', 'Roast lamb, red meat.') },
  { barcode: '8690000000288', name: 'Ege Sauvignon Blanc', brand: 'Ege Bağları', color: 'white', country: 'TR', region: 'Ege', grape: 'Sauvignon Blanc', price: 550, stock: 35, block: 'B', shelf: 13, active: true, body: 'light', sweetness: 'light', acidity: 'intense', tannin: 'light', usagePurposes: ['light', 'daily', 'value'], sommelierPick: false, priorityScore: 10, featured: false, image: '', shortDescription: tn('Canlı ve aromatik Ege beyazı.', 'Lively and aromatic Aegean white.'), tasteNotes: tn('Çarkıfelek meyvesi, misket limonu.', 'Passion fruit, lime.'), foodPairing: tn('Keçi peynirli salata, zeytinyağlılar.', 'Goat cheese salad, olive oil dishes.') },
  { barcode: '8690000000295', name: 'Amarone Classico', brand: 'Villa Veneto', color: 'red', country: 'IT', region: 'Veneto', grape: 'Corvina Blend', price: 3800, stock: 4, block: 'C', shelf: 3, active: true, body: 'intense', sweetness: 'medium', acidity: 'medium', tannin: 'medium', usagePurposes: ['premium', 'gift', 'celebration'], sommelierPick: true, priorityScore: 28, featured: true, image: '', shortDescription: tn('Kurutulmuş üzümlerden muazzam yoğunluk.', 'Immense intensity from dried grapes.'), tasteNotes: tn('Kuru incir, bitter çikolata, kiraz reçeli.', 'Dried fig, dark chocolate, cherry jam.'), foodPairing: tn('Yaban domuzu, mavi küflü peynirler.', 'Wild boar, blue cheeses.') },
  { barcode: '8690000000301', name: 'Rosé Impérial', brand: 'Maison Champagne', color: 'sparkling', country: 'FR', region: 'Champagne', grape: 'Pinot Noir Blend', price: 5200, stock: 6, block: 'D', shelf: 4, active: true, body: 'medium', sweetness: 'light', acidity: 'intense', tannin: 'light', usagePurposes: ['celebration', 'romantic', 'premium'], sommelierPick: true, priorityScore: 30, featured: true, image: '', shortDescription: tn('Lüks ve zarif pembe şampanya.', 'Luxurious and elegant pink champagne.'), tasteNotes: tn('Yabani çilek, gül yaprağı.', 'Wild strawberry, rose petal.'), foodPairing: tn('Somon, kırmızı meyveli tatlılar.', 'Salmon, red berry desserts.') }
]
